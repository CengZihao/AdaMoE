...
class LoraModel(torch.nn.Module):
    ...
    **Attributes**:
    ...
    def _create_new_module(self, lora_config, adapter_name, target, layer_index, number_experts, top_k):
        ...
        if loaded_in_8bit and isinstance(target, bnb.nn.Linear8bitLt):
            ...
            new_module = Linear_MoE(adapter_name, in_features, out_features, bias=bias, layer_index=layer_index,
                                number_experts=number_experts, top_k=top_k, **kwargs)
    ...
    def _find_and_replace(self, adapter_name):
        ...
        for key in key_list:
            ...
            if isinstance(target, LoraLayer) and isinstance(target, torch.nn.Conv2d):
                ...
                new_module = self._create_new_module(lora_config, adapter_name, target, layer_index, self.number_experts, self.top_k)
...
class LoraLayer:
    ...
    def update_layer(self, adapter_name, r, lora_alpha, lora_dropout, init_lora_weights, layer_index):
...
class Linear_MoE(nn.Linear, LoraMoE_Layer):
    def __init__(
        ...
        **kwargs,
        ...
        self.update_layer(adapter_name, r, lora_alpha, lora_dropout, init_lora_weights, layer_index)
    ...
    def forward(self, x: torch.Tensor):
        ...
        mask = (selected_experts >= 0) & (selected_experts <= 3)
